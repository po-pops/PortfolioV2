...
export default function AkiProject() {
  return (
    <main className={styles.projectPage}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroContainer}>
          <div className={styles.heroInfoCard}>
            <span className={styles.subTitleHero}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Marquee items={["UX/UI Design", "Direction artistique"]} />
      ...
      <section className={`${styles.besoinSection} bg-grid`}>
        <div className={styles.container}>
          ...
          <div className={styles.besoinTextContainer}>
            <FadeText text="Dans le cadre de la Bacchanight, nocturne étudiante organisée par le Musée des Beaux-Arts de Bordeaux, notre mission était de concevoir une expérience interactive capable de dynamiser la visite du musée et de capter un public jeune." />
            <FadeText text="Le musée souhaitait offrir une médiation innovante, capable de transformer la posture traditionnelle du visiteur souvent passive en une expérience participative. Il fallait créer un outil à la fois pédagogique, ludique et adapté aux usages numériques des étudiants." />
          </div>
        </div>
      </section>
        ...
        <div className={styles.container}>
          ...
          <div className={styles.artLayout}>
            <div className={styles.swatchesRow}>
              <div className={styles.swatch} style={{ backgroundColor: '#151515' }}></div>
              <div className={styles.swatch} style={{ backgroundColor: '#FFF' }}></div>
              <div className={styles.swatch} style={{ backgroundColor: '#A9D0E4' }}></div>
              <div className={styles.swatch} style={{ backgroundColor: '#F5A3E0' }}></div>
              <div className={styles.swatch} style={{ backgroundColor: '#FF7442' }}></div>
              <div className={styles.swatch} style={{ backgroundColor: '#8BC062' }}></div>
            </div>
          ...
          <div className={styles.stickersGallery}>
            <Image src="/projects/aki/stickers.svg" alt="Aki Stickers" width={650} height={350} className={styles.mainSticker} />
          </div>
        </div>
      </section>
