    ...
    <header className={styles.header}>
      ...
      <div className={`${styles.sidebar} ${isMenuOpen ? styles.sidebarOpen : ''}`}>
        ...
        <div className={styles.mobileSocials}>
           {/* Instagram Icon */}
           <a href="https://www.instagram.com/popsdoesartstuff/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="Instagram">
             <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           {/* LinkedIn Icon */}
           <a href="https://www.linkedin.com/in/pauline-yvelin-a737b6386/" target="_blank" rel="noopener noreferrer" className={styles.socialIcon} aria-label="LinkedIn">
             <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           {/* Email Icon */}
           <a href="mailto:pauline.yvelin@mmibordeaux.com" className={styles.socialIcon} aria-label="Email">
             <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
